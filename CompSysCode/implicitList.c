...
#define NEXT_FITx //If NEXT_FIT defined use next fit search, else use first-fit search
 ...
 */mt(void) //Performs the neccesary initializations such as allocating the initial heap area. Return  value should return 0 if okay, -1 if not okay
{
